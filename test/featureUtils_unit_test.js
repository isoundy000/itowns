import GeoJSON2Feature from '../src/Renderer/ThreeExtended/GeoJSON2Feature';
...
const feature = GeoJSON2Feature.parse('EPSG:4326', geojson, undefined, { buildExtent: true });
